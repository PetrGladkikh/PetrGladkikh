# Привет, меня зовут Петр!
 Тестировщик программного обеспечения. Здесь я хочу поделиться некоторыми элементами портфолио по веб- и мобильному тестированию, полученными во время работы и выполения домашних проектов.
